...
<img src="docs/Jotbook.gif" alt="搜自己的命令，填好变量，命令落到你的命令行上" width="100%">
...
`jot new` 建一本，`jot save` 会问你存哪本，选择器里打 `@名字` 就只看那一本：

<img src="docs/Jotbook-notebook.gif" alt="新建笔记本、把命令存进去、再找回来" width="100%">
